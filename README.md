...
> 这里的每一条 Skill，都经过上万创作者在真实短剧生产流水线中跑过验证。  
> 直接复制使用，或在 LuxReal直接选中使用开始创作。
...
| # | Skill | 用途 | 适合场景 |
|---|-------|------|---------|
| 04 | [单视频提示词润色](#05-单视频提示词润色) | 将剧情描述转化为结构化镜头提示词 | 通用出片、常规剧情段落 |
| 05 | [高能戏剧化情节润色](#06-高能戏剧化情节润色) | 好莱坞动作风格的高冲击力提示词生成 | 动作高潮、前3秒黄金开场、蒙太奇 |
| 06 | [慢节奏细腻质感润色](#07-慢节奏细腻质感润色) | 文艺抒情风格的细腻情感提示词生成 | 情感高能、内心独白、诗意氛围段落 |
